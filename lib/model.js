...
function Model(document) {
  ...
  Object.defineProperty(self, 'isNew', {
    value: !document || !document._id,
    configurable: false,
    writable: true
  });

  // alias ?id to id, for retrocompatibility
...
Model.prototype.set = function(data, options) {
  ...
  */
  ...
  return self.constructor.set(self._id, document, options)
...
Model.prototype.save = function(options) {
  ...
  if(self.id){
    ...
    return self.set(self.toObject(), options);
  }
...
Model.prototype.remove = function(options) {
  ...
  .then(function(){
    return self.constructor.remove(self.id, options);
  })
  .then(function(){
